...
namespace WinFormApp_ProdInOut
{
    public partial class ProdInOut : Form
    {
        ...
        private void txtFactNo_Leave(object sender, EventArgs e)
        {
            ...
            // 轉換為大寫並去除空白
            txtFactNo.Text = txtFactNo.Text.Trim().ToUpper();
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            // 轉換為大寫並去除空白
            txtProdNo.Text = txtProdNo.Text.Trim().ToUpper();
            ...
            try
            {
                using (SqlConnection mySqlConn = new SqlConnection(strConnString))
                {
                    ...
                    using (SqlCommand sqlCmd = new SqlCommand(strSQL, mySqlConn))
                    {
                        ...
                        if (txtUnit.Text.Trim() == "") txtUnit.Text = dt.Rows[0]["chUnit"].ToString().Trim();                //單位
